 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function tf(e){if(e)try{let t=new Date(Number(e));if(!isNaN(t.getTime()))return t.toUTCString()}catch(e){}}async function tm(e,t=!1){let r=J(e),i=await r.getIdToken(t),n=tv(i);e3(n&&n.exp&&n.auth_time&&n.iat,r.auth,"internal-error");let s="object"==typeof n.firebase?n.firebase:void 0,a=null==s?void 0:s.sign_in_provider;return{claims:n,token:i,authTime:tf(tg(n.auth_time)),issuedAtTime:tf(tg(n.iat)),expirationTime:tf(tg(n.exp)),signInProvider:a||null,signInSecondFactor:(null==s?void 0:s.sign_in_second_factor)||null}}function tg(e){return 1e3*Number(e)}function tv(e){let[t,r,i]=e.split(".");if(void 0===t||void 0===r||void 0===i)return eX("JWT malformed, contained fewer than 3 sections"),null;try{let e=P(r);if(!e)return eX("Failed to decode base64 JWT payload"),null;return JSON.parse(e)}catch(e){return eX("Caught error parsing JWT payload as JSON",null==e?void 0:e.toString()),null}}function ty(e){let t=tv(e);return e3(t,"internal-error"),e3(void 0!==t.exp,"internal-error"),e3(void 0!==t.iat,"internal-error"),Number(t.exp)-Number(t.iat)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */let tR=new Map;function tA(e){var t,r;t="Expected a class definition",e instanceof Function||e6(t);let i=tR.get(e);return i?(r="Instance stored in cache mismatched with class",i instanceof e||e6(r)):(i=new e,tR.set(e,i)),i}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class rO{constructor(e,t){this.storageRetriever=e,this.type=t}_isAvailable(){try{if(!this.storage)return Promise.resolve(!1);return this.storage.setItem(rC,"1"),this.storage.removeItem(rC),Promise.resolve(!0)}catch(e){return Promise.resolve(!1)}}_set(e,t){return this.storage.setItem(e,JSON.stringify(t)),Promise.resolve()}_get(e){let t=this.storage.getItem(e);return Promise.resolve(t?JSON.parse(t):null)}_remove(e){return this.storage.removeItem(e),Promise.resolve()}get storage(){return this.storageRetriever()}}class rP extends rO{constructor(){super(()=>window.localStorage,"LOCAL"),this.boundEventHandler=(e,t)=>this.onStorageEvent(e,t),this.listeners={},this.localCache={},this.pollTimer=null,this.safariLocalStorageNotSynced=/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class rR extends rO{constructor(){super(()=>window.sessionStorage,"SESSION")}_addListener(e,t){}_removeListener(e,t){}}rR.type="SESSION";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function(e,t){let r=eR(e,"auth");if(r.isInitialized()){let e=r.getImmediate();if(B(r.getOptions(),null!=t?t:{}))return e;eQ(e,"already-initialized")}return r.initialize({options:t})}(e,{popupRedirectResolver:iy,persistence:[rq,rP,rR]}),i=U("authTokenSyncURL");if(i&&"boolean"==typeof isSecureContext&&isSecureContext){let e=new URL(i,location.origin);if(location.origin===e.origin){var n,s;let t=iP(e.toString());n=()=>t(r.currentUser),J(r).beforeAuthStateChanged(t,n),s=e=>t(e),J(r).onIdTokenChanged(s,void 0,void 0)}}let a=D("auth");return a&&function(e,t,r){let i=J(e);e3(i._canInitEmulator,i,"emulator-config-failed"),e3(/^https?:\/\//.test(t),i,"invalid-emulator-scheme");let n=t2(t),{host:s,port:a}=function(e){let t=t2(e),r=/(\/\/)?([^?#/]+)/.exec(e.substr(t.length));if(!r)return{host:"",port:null};let i=r[2].split("@").pop()||"",n=/^(\[[^\]]+\])(:|$)/.exec(i);if(n){let e=n[1];return{host:e,port:t3(i.substr(e.length+1))}}{let[e,t]=i.split(":");return{host:e,port:t3(t)}}}(t),o=null===a?"":`:${a}`;i.config.emulator={url:`${n}//${s}${o}/`},i.settings.appVerificationDisabledForTesting=!0,i.emulatorConfig=Object.freeze({host:s,port:a,protocol:n.replace(":",""),options:Object.freeze({disableWarnings:!1})}),function(){function e(){let e=document.createElement("p"),t=e.style;e.innerText="Running in emulator mode. Do not use with production credentials.",t.position="fixed",t.width="100%",t.backgroundColor="#ffffff",t.border=".1em solid #000000",t.color="#b50000",t.bottom="0px",t.left="0px",t.margin="0px",t.zIndex="10000",t.textAlign="center",e.classList.add("firebase-emulator-warning"),document.body.appendChild(e)}"undefined"!=typeof console&&"function"==typeof console.info&&console.info("WARNING: You are using the Auth Emulator, which is intended for local testing only.  Do not use with production credentials."),"undefined"!=typeof window&&"undefined"!=typeof document&&("loading"===document.readyState?window.addEventListener("DOMContentLoaded",e):e())}()}(r,`http://${a}`),r}();s=e=>{e?(console.log(`User is logged in as: ${e.email}`),iq.style.display="none",i6.style.visibility="visible",iK.textContent=e.email):(console.log("No user is currently logged in."),iq.style.display="block",i6.style.visibility="hidden",iK.textContent="")},J(iF).onAuthStateChanged(s,void 0,void 0);let iV=document.querySelector(".email"),ij=document.querySelector(".password"),iH=document.querySelector(".sign-in-button"),iB=document.querySelector(".email-error"),i$=document.querySelector(".password-error"),iz=document.querySelector(".sign-in-form"),iW=document.querySelector(".sign-in-error"),iq=document.querySelector(".sign-in-form-container"),iK=document.querySelector(".user-name");iH.addEventListener("click",e=>{e.preventDefault(),iR(iV.value,ij.value,iB,i$)});let iG=document.querySelector(".firstname"),iJ=document.querySelector(".lastname"),iY=document.querySelector(".sign-up-email"),iX=document.querySelector(".sign-up-password"),iQ=document.querySelector(".sign-up-error"),iZ=document.querySelector(".sign-up-form"),i0=document.querySelector(".form-close"),i1=document.querySelector(".sign-up-form__open"),i2=document.querySelector(".sign-up-form-container"),i3=document.querySelector(".sign-up-button");i1.addEventListener("click",e=>{e.preventDefault(),i2.style.display="block"}),i0.addEventListener("click",e=>{e.preventDefault(),i2.style.display="none"}),i3.addEventListener("click",e=>{e.preventDefault(),iA(iG.value,iJ.value,iY.value,iX.value,iQ)}),i3.addEventListener("click",e=>{e.preventDefault(),function(){let{signUpErrorStatus:e}=iA(iG.value.trim(),iJ.value.trim(),iY.value.trim(),iX.value.trim(),iQ);if(!e()){let e={firstname:iG.value.trim(),lastname:iJ.value.trim(),signUpEmail:iY.value.trim(),signUpPassword:iX.value.trim()};rk(iF,e.signUpEmail,e.signUpPassword).then(()=>{iZ.reset(),i2.style.display="none"}).catch(e=>console.log(e.message))}}()});let i6=document.querySelector(".sign-out-button");i6.addEventListener("click",e=>{e.preventDefault(),J(iF).signOut().then(()=>{console.log("Sign out successful!"),i6.style.visibility="hidden",iz.style.display="flex"}).catch(e=>console.log(e.message))}),iH.addEventListener("click",e=>{e.preventDefault(),function(){let{signInFormStatus:e}=iR(iV.value,ij.value,iB,i$);if(!e()){let e=iV.value.trim(),t=ij.value.trim();(eA(iF.app)?Promise.reject(e1(iF)):rT(J(iF),rc.credential(e,t)).catch(async e=>{throw"auth/password-does-not-meet-requirements"===e.code&&rS(iF),e})).then(()=>{iz.reset(),iq.style.display="none",i6.style.visibility="visible",console.log("Sign in successful!");let e=iF.currentUser;e?console.log(`Logged in as: ${e.email}`):console.log("No user is currently logged in.")}).catch(e=>{iW.style.visibility="visible",console.log("Sign in failed:",e.message)})}}()}),document.addEventListener("DOMContentLoaded",()=>{let e=document.querySelector(".new-post-button"),t=document.querySelector(".new-post-container"),r=document.querySelector(".new-post-form"),i=document.querySelector("input.post-title"),n=document.querySelector("select.new-post-category"),s=document.querySelector("textarea.new-post-content"),a=document.querySelector(".new-post-button-close");document.querySelector(".new-post--submit-error"),e.addEventListener("click",e=>{e.preventDefault(),t.style.visibility="visible",a.style.visibility="visible"}),a.addEventListener("click",e=>{e.preventDefault(),t.style.visibility="hidden",a.style.visibility="hidden"});let o=document.querySelector(".post-container"),l=JSON.parse(localStorage.getItem("posts"))||[];console.log("Posts array outside the function:",l),localStorage.setItem("posts",JSON.stringify(l)),l.forEach(e=>{let t=document.createElement("div");t.classList.add("post"),t.dataset.category=e.category;let r=document.createElement("h2");r.classList.add("post-title"),r.textContent=e.title;let i=document.createElement("p");i.classList.add("post-category"),i.textContent=e.category;let n=document.createElement("p");n.classList.add("new-post-content"),n.textContent=e.content,t.appendChild(r),t.appendChild(i),t.appendChild(n),o.appendChild(t)});let c=document.querySelectorAll(".tag-button"),u=e=>{let t=e.currentTarget.dataset.filterBy,r=[...document.querySelectorAll(".post")].filter(e=>"all"===t||e.dataset.category===t);o.innerHTML="",r.forEach(e=>{o.appendChild(e)})};c.forEach(e=>{e.addEventListener("click",u)}),r.addEventListener("submit",function(e){e.preventDefault();let a=i.value,o=n.value,c=s.value;return l.push({title:a,category:o,content:c}),console.log("Posts array inside function:",l),localStorage.setItem("posts",JSON.stringify(l)),console.log("Stored posts:",JSON.parse(localStorage.getItem("posts"))),r.reset(),t.style.visibility="hidden",l})})}();
